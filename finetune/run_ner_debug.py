...
if __name__ == '__main__':
    ...
    # --task naver-ner --config_file koelectra-small.json
    cli_parser.add_argument("--task", type=str, required=False, default="naver-ner")
    cli_parser.add_argument("--config_dir", type=str, default="config")
    cli_parser.add_argument("--config_file", type=str, required=False, default="koelectra-small.json")
